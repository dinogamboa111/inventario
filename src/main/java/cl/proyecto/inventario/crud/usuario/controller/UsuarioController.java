package cl.proyecto.inventario.crud.usuario.controller;
...
import cl.proyecto.inventario.crud.usuario.service.impl.UsuarioServiceImpl;
...
public class UsuarioController {
    ...
    public ResponseEntity<UsuarioDTO> create(@RequestBody UsuarioDTO usuario) {
        UsuarioDTO usuarioCreado = usuarioService.insert(usuario);
    ...
    // bbtener todas las usuarios (listar)
    @GetMapping
